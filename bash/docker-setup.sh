...
echo "➡️  NGINX Proxy Manager should be reachable at: http://$PUBLICIP:81"
echo "🛠️  Portainer UI may be accessible at: http://$PUBLICIP:9000"
echo "👤 Default credentials for NGINX: username 'admin', password 'changeme'"
